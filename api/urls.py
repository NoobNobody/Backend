...
from .views import JobOffersList, CategoriesList, FilterAllJobOffers, JobOffersAnalysis, JobOffersCategoryAnalysis, AverageEarningsAnalysis, EarningsHeatmapAnalysis
